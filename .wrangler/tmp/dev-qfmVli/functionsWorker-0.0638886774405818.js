// .wrangler/tmp/bundle-O9GqOi/checked-fetch.js
...
// .wrangler/tmp/pages-N7vyGA/functionsWorker-0.0638886774405818.mjs
...
var init_checked_fetch = __esm({
  "../.wrangler/tmp/bundle-aMbxDV/checked-fetch.js"() {
...
var init_wrangler_modules_watch = __esm({
  "wrangler-modules-watch:wrangler:modules-watch"() {
    init_functionsRoutes_0_21839211799989489();
    init_checked_fetch();
...
async function onRequestGet5(context) {
  ...
  if (theToken.payload.isAdmin == 1) {
    ...
    let sqlOrderBy = "";
    if (orderBy != "") {
      sqlOrderBy = `ORDER BY datePaid ${orderBy}`;
    }
    ...
    if (tmp.length == 1) {
      ...
      theQuery = `SELECT ${fields2} from ${tableName} ${sqlWhere} ${sqlOrderBy}`;
      console.log(theQuery);
      query = context.env.DB.prepare(theQuery);
    }
...
var routes;
var init_functionsRoutes_0_21839211799989489 = __esm({
  "../.wrangler/tmp/pages-N7vyGA/functionsRoutes-0.21839211799989489.mjs"() {
    init_account();
    init_email();
    init_image();
    init_lookUp();
...
// .wrangler/tmp/bundle-O9GqOi/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-O9GqOi/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.0638886774405818.js.map
